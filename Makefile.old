...
drive_rx915.py: drive-rx.grc
	...
	patch drive_rx915.py < sleep4.patch

drive_rx24.py: drive-rx.grc
	grcc drive-rx.grc -d .
	mv drive_rx.py drive_rx24.py
	patch drive_rx24.py < sleep4.patch
...
drive_tx915.py: drive-tx.grc
	...
	patch drive_tx915.py < sleep2.patch

drive_tx24.py: drive-tx.grc
	grcc drive-tx.grc -d .
	mv drive_tx.py drive_tx24.py
	patch drive_tx24.py < sleep2.patch
...
clean:
	rm -f drive_rx.py drive_tx915.py drive_tx24.py top_block.py drive_rx915.py drive_rx24.py *orig *pyc
